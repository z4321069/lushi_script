...
class Agent:
    def __init__(self, cfg):
        ...
        self.states = ['box','else_mode', 'mercenaries', 'team_lock', 'travel', 'boss_list', 'team_list', 'map_not_ready',
                       ...
                       'treasure_list', 'treasure_replace', 'treasure_list2', 'destroy', 'blue_portal','cursed_treasure', 'boom', 'bonus_loot', 'collect', 'visitor_list',
    ...
    def state_handler(self, state, tic, text):
        ...
        if success:
            ...
            if state in ['destroy', 'blue_portal', 'boom', 'bonus_loot', 'cursed_treasure','collcet']:
                logger.info(f'find {state}, try to click')
